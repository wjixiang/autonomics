#![allow(dead_code)]
//! Shared test helpers for eutils-rs E2E tests.
//!
//! # Concurrency model
//!
...
pub fn test_client() -> eutils_rs::EutilsClient {
    eutils_rs::EutilsClient::new("eutils-rs-tests", "eutils-rs-tests@localhost", None)
}
