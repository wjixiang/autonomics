//! DataFusion-based query workspace for Iceberg tables.
//!
//! [`AetherWorkspace`] wraps a `SessionContext` with the Iceberg catalog
...
pub struct AetherWorkspace {
    datalake: Arc<Datalake>,
    ctx: SessionContext,
}

impl AetherWorkspace {
